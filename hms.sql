...
INSERT INTO `appointment_appointmentbooking` VALUES (4,'2022-02-20',10,'booked','pending',1,5,NULL),(5,'2022-02-20',11,'booked','pending',1,5,NULL),(6,'2022-02-20',12,'booked','pending',1,9,NULL);
...
INSERT INTO `auth_user_groups` VALUES (2,2,1),(4,7,3),(5,8,2),(6,9,2),(7,10,2),(8,11,2),(9,12,2),(10,13,2),(11,14,2),(12,15,2),(13,16,2),(14,17,2),(15,18,2),(16,19,2),(17,20,2),(18,21,2),(19,22,2),(20,24,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(12,'appointment','appointmentbooking'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(9,'userAuth','doctordetails'),(11,'userAuth','nonregisteredpatientdetails'),(8,'userAuth','patientdetails'),(7,'userAuth','personaldetails'),(10,'userAuth','staffdetails');
...
INSERT INTO `userauth_nonregisteredpatientdetails` VALUES (5,'dipak rai',23,'M',9841749779,'galfutar'),(9,'asshish ghama',22,'M',9841749778,'futung'),(10,'yukta',22,'M',9841776656,'swyambhu');
...
INSERT INTO `userauth_patientdetails` VALUES (1,'Sudip Tamang',21,'M',9843103378,'jorpati','profilepic/bikebazar-logo_2.png',2),(2,'sajani budathoki',21,'F',9843223232,'naryanthan','',24);
...
-- Dump completed on 2022-02-20  0:45:59
